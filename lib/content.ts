...
export const footerSection = {
  ...
  social: [
    ...
    {
      platform: "Facebook",
      url: "https://facebook.com/tmew.ng",
      icon: "facebook",
    },
    {
      platform: "YouTube",
...
export const images = {
  ...
  about: {
    main: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=800&q=80",
  },
  experience: {
    gallery: [
  ...
  vision: {
    main: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=800&q=80",
  },
  team: {
    placeholders: [
      "/mary.jpg",
